...
const (
	CharacterService_GetCharacters_FullMethodName   = "/panelplay.v1.CharacterService/GetCharacters"
	CharacterService_ExtractAndStore_FullMethodName = "/panelplay.v1.CharacterService/ExtractAndStore"
)
...
type CharacterServiceClient interface {
	GetCharacters(ctx context.Context, in *TitleRequest, opts ...grpc.CallOption) (*CharacterListResponse, error)
	ExtractAndStore(ctx context.Context, in *ExtractRequest, opts ...grpc.CallOption) (*CharacterListResponse, error)
}
...
func (c *characterServiceClient) GetCharacters(ctx context.Context, in *TitleRequest, opts ...grpc.CallOption) (*CharacterListResponse, error) {
...
func (c *characterServiceClient) ExtractAndStore(ctx context.Context, in *ExtractRequest, opts ...grpc.CallOption) (*CharacterListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CharacterListResponse)
	err := c.cc.Invoke(ctx, CharacterService_ExtractAndStore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CharacterServiceServer interface {
	GetCharacters(context.Context, *TitleRequest) (*CharacterListResponse, error)
	ExtractAndStore(context.Context, *ExtractRequest) (*CharacterListResponse, error)
...
func (UnimplementedCharacterServiceServer) GetCharacters(context.Context, *TitleRequest) (*CharacterListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCharacters not implemented")
}
func (UnimplementedCharacterServiceServer) ExtractAndStore(context.Context, *ExtractRequest) (*CharacterListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExtractAndStore not implemented")
}
...
func _CharacterService_GetCharacters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CharacterServiceServer).GetCharacters(ctx, req.(*TitleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CharacterService_ExtractAndStore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExtractRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CharacterServiceServer).ExtractAndStore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CharacterService_ExtractAndStore_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CharacterServiceServer).ExtractAndStore(ctx, req.(*ExtractRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CharacterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "panelplay.v1.CharacterService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExtractAndStore",
			Handler:    _CharacterService_ExtractAndStore_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "panelplay/v1/character.proto",
}
